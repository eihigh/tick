// Package tick allows you to measure the ticks that have elapsed (which you need to advance yourself)
// and switch the flow of processing accordingly.
// This feature can be used as a replacement for a coroutine.
package tick
